...
const CustomDropdown = ({ country, data }) => {
  ...
  return (
    ...
    >
      <button
        className="flex items-center -1 text-white hover:text-orange-500 transition-colors focus:outline-none"
...
const ContactSection = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-gray-900 to-black p-8 text-white">
      <div className="max-w-[1380px] mx-auto grid grid-cols-1 md:grid-cols-2 -12">
        {/* Contact Form */}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 -4">
              <div>
                <input
                  ...
                  className="w-full p-3 border-b text-black border-gray-300 rounded"
                  required
                />
              </div>
              <div>
            ...
            <div>
              <textarea
                ...
                className="w-full p-3 border text-black border-gray-300 rounded h-32"
                required
              />
            </div>

            <div className="space-y-2">
              <div className="flex items-start -2">
                <input
                  type="checkbox"
                  name="hasReadPrivacy"
        ...
        <div className="space-y-12 ml-10">
          <div>
            ...
            <div className="grid grid-cols-3 -8">
              <div>
